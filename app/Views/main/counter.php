        ...
        <div class="col-8">
            <div class="card shadow-sm bg-body rounded">
                <div class="card-body">
                    ...
                    <h1 class="display-4"><?= $short['counter'] ?></h1>
                    <p>Long URL: <a href="<?= $short['url'] ?>"><?= $short['url'] ?></a></p>
                    <p>Short URL: <a href="<?= base_url() . "/s/" . $short['slug'] ?>"><?= base_url() . "/s/" . $short['slug'] ?></a></p>
                    <p>Our tool will count each click as one hit to the long URL, even if there are multiple clicks from the same person or device.
                        Check <a href="<?= base_url() . '/c' ?>">the total number of clicks</a> from other URL.
                    </p>
                </div>
            </div>
        </div>
